...
Let's say that this is your disease data for the last 4 years, aggregated by month. This shows a clear seasonal pattern, with a peak in January.
...
To answer this question, we can create an evaluation. An evaluation takes in a set of parameters defined by the model you are using, and splits the data into training and test sets automatically. 
...
- The model parameters need to be tuned or adjusted
